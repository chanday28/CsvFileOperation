...
namespace TsvFileOperation.Tests
{
    [TestClass()]
    public class ProgramTests
    {
        ...
        {
            Environment.CurrentDirectory = "../TsvFileOperation/bin/Debug/"; //Need to change as per path.. Need this dynamic
        ...
        {
            Environment.CurrentDirectory = "../TsvFileOperation/bin/Debug/";
